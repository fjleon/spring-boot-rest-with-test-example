...
/**
 * Comparator object to order integers according to the numbers of matches of number 1 in binary base.
 * Decimal base value has precedence if two ordered values are equals.
 */
